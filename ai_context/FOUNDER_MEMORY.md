...
**Attributes:**
*   **Crisis Management:** High. Does not panic under platform pressure (e.g., X Ads bans).
...
*   **Risk Tolerance:** Calculated. Willing to "Kill Darlings" (pivot branding) but protects the asset (didn't delete account).
...
*   **Aesthetic:** Dark Mode, Neon, Cyberpunk, Glitch.
*   **Code Style:** Clean, component-based, but with "Soul" (Easter eggs, console logs).

---
*To be updated by The Founder. This file serves as the source of truth for all future agents.*
