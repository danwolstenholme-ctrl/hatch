...
export default function DashboardPage() {
  ...
  const intelligenceTools = [
    {
      name: 'Pip',
      description: 'Your AI sidekick — powered by Gemini to refine prompts before Claude builds.',
      status: 'Online',
        ...
        >
          ...
          {hasProjects ? (
            ...
            <div className="rounded-2xl border border-dashed border-zinc-700 bg-zinc-800/30 p-8 text-center">
              <div className="w-12 h-12 mx-auto rounded-lg bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center">
                <span className="text-emerald-400 font-mono text-lg font-bold">It</span>
              </div>
              <p className="mt-4 text-sm text-zinc-400">No projects yet. Start your first build to ship production code.</p>
              <div className="mt-5">
                <Button
                  onClick={handleCreate}
                  disabled={isCreating}
        ...
        >
          <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h2 className="text-xl font-semibold text-zinc-100">Pip, Witness & friends</h2>
