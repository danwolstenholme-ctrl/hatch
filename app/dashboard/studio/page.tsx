      ...
      <div className="relative max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="mt-16 pt-8 border-t border-white/[0.06]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="px-2 py-0.5 bg-amber-500/10 text-amber-500 text-[10px] font-bold rounded uppercase tracking-wider">Roadmap</span>
            </div>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {/* Replicator */}
              <div className="group relative bg-white/[0.02] border border-white/[0.06] rounded-xl p-5 opacity-60 cursor-not-allowed overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-violet-500/5 to-transparent" />
                <div className="relative">
                  <div className="w-10 h-10 bg-violet-500/10 rounded-lg flex items-center justify-center mb-4">
                    <Zap className="w-5 h-5 text-violet-400" />
                  </div>
                  <h3 className="font-medium text-white mb-1">Replicator</h3>
                  <p className="text-xs text-zinc-500">
                    Paste any URL → AI clones the design in seconds. Your vision, built instantly.
                  </p>
                  <div className="mt-4 flex items-center gap-1.5 text-[10px] text-violet-400/60 uppercase tracking-wider">
                    <span className="w-1 h-1 bg-violet-400/60 rounded-full" />
                    In Development
                  </div>
                </div>
              </div>
              ...
              <div className="group relative bg-white/[0.02] border border-white/[0.06] rounded-xl p-5 opacity-60 cursor-not-allowed overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="font-medium text-white mb-1">Form Intelligence</h3>
                  <p className="text-xs text-zinc-500">
                    AI guides form best practices, validates fields, connects to backends automatically.
                  </p>
                  <div className="mt-4 flex items-center gap-1.5 text-[10px] text-cyan-400/60 uppercase tracking-wider">
              ...
              <div className="group relative bg-white/[0.02] border border-white/[0.06] rounded-xl p-5 opacity-60 cursor-not-allowed overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="font-medium text-white mb-1">Backend AI</h3>
                  <p className="text-xs text-zinc-500">
                    &quot;Add a database&quot; → AI provisions Supabase, writes schemas, connects it all.
                  </p>
                  <div className="mt-4 flex items-center gap-1.5 text-[10px] text-amber-400/60 uppercase tracking-wider">
              ...
              <div className="group relative bg-white/[0.02] border border-white/[0.06] rounded-xl p-5 opacity-60 cursor-not-allowed overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="font-medium text-white mb-1">Plugin Marketplace</h3>
                  <p className="text-xs text-zinc-500">
                    One-click add Stripe payments, Auth0 login, Analytics, CMS, and more.
                  </p>
                  <div className="mt-4 flex items-center gap-1.5 text-[10px] text-pink-400/60 uppercase tracking-wider">
                    <span className="w-1 h-1 bg-pink-400/60 rounded-full" />
                    Vision
                  </div>
                </div>
              </div>
              ...
              <div className="group relative bg-white/[0.02] border border-white/[0.06] rounded-xl p-5 opacity-60 cursor-not-allowed overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="font-medium text-white mb-1">Analytics Dashboard</h3>
                  <p className="text-xs text-zinc-500">
                    Track visitors, conversions, and performance across all your deployed sites.
                  </p>
                  <div className="mt-4 flex items-center gap-1.5 text-[10px] text-blue-400/60 uppercase tracking-wider">
                    <span className="w-1 h-1 bg-blue-400/60 rounded-full" />
                    Planned
                  </div>
                </div>
              </div>
              ...
              <div className="group relative bg-white/[0.02] border border-white/[0.06] rounded-xl p-5 opacity-60 cursor-not-allowed overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-xs text-zinc-500">
                    Share projects, real-time co-editing, comments, and handoff to developers.
                  </p>
                  <div className="mt-4 flex items-center gap-1.5 text-[10px] text-green-400/60 uppercase tracking-wider">
                    <span className="w-1 h-1 bg-green-400/60 rounded-full" />
                    Vision
                  </div>
                </div>
              </div>
