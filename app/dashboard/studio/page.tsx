      ...
      <div className="relative max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="mt-16 pt-8 border-t border-white/[0.06]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="group relative bg-white/[0.02] border border-emerald-500/20 rounded-xl p-5 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-transparent" />
                <div className="relative">
                  <div className="w-10 h-10 bg-emerald-500/10 rounded-lg flex items-center justify-center mb-4">
                    <Zap className="w-5 h-5 text-emerald-400" />
                  </div>
                  <h3 className="font-medium text-white mb-1">URL Replicator</h3>
                  <p className="text-xs text-zinc-500">
                    Paste any URL → AI extracts the design DNA and recreates it as your starting point.
                  </p>
                  <div className="mt-4 flex items-center gap-1.5 text-[10px] text-emerald-400 uppercase tracking-wider">
              ...
              <div className="group relative bg-white/[0.02] border border-white/[0.06] rounded-xl p-5 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="font-medium text-white mb-1">Code Export</h3>
                  <p className="text-xs text-zinc-500">
              ...
              <div className="group relative bg-white/[0.02] border border-white/[0.06] rounded-xl p-5 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="font-medium text-white mb-1">Custom Domains</h3>
                  <p className="text-xs text-zinc-500">
