    ...
    questions: [
      {
        ...
        a: 'System access is tiered. Free Tier grants 5 generations/day. Pro Tier (/mo) grants unlimited generation, full deployment capabilities, and code export. Agency Tier (/mo) adds unlimited Opus refinement cycles.',
      },
      {
