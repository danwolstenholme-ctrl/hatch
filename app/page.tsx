      ...
      <footer className="border-t border-zinc-800 px-6 py-12">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4"><Image src="/assets/logo.png" alt="HatchIt" width={40} height={40} className="w-10 h-10" /><span className="font-bold text-xl"><span className="text-white">Hatch</span><span className="bg-gradient-to-r from-amber-500 to-amber-400 bg-clip-text text-transparent">It</span></span></div>
