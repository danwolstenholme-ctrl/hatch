  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 mb-8 flex flex-col items-center">
        <h1 className="text-2xl font-bold text-white tracking-tight">Join the Singularity</h1>
        <p className="text-emerald-500/60 font-mono text-sm mt-2">Initiate Protocol: CREATION</p>
      </div>

      <SignUp afterSignUpUrl="/welcome" appearance={{
        elements: {
